...
<head>
    ...
    <title>Centered Bootstrap Navbar Preview</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
    
    <style>
        /* This custom style is necessary to show your hamburger icon spans */
        ...
        /* Add some body height to demonstrate sticky-top working */
        body {
            height: 200vh;
...
<body>
    ...
    >
        ...
        <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                <li class="nav-item"><a href="#about" class="nav-link" data-bs-dismiss="offcanvas">About</a></li>
                <li class="nav-item"><a href="#Education" class="nav-link" data-bs-dismiss="offcanvas">Education</a></li>
                <li class="nav-item"><a href="#skills" class="nav-link" data-bs-dismiss="offcanvas">Skills</a></li>
                <li class="nav-item"><a href="#Experience" class="nav-link" data-bs-dismiss="offcanvas">Experiences</a></li>
                <li class="nav-item"><a href="#Hobbies" class="nav-link" data-bs-dismiss="offcanvas">Hobbies</a></li>
    ...
    <div class="container mt-5">
        <h1>Welcome to Diego's Portfolio</h1>
        <p>Scroll down to see the sticky header in action. Resize the browser window to see the mobile menu appear!</p>
    </div>
